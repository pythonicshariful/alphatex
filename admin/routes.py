...
from models import AdminUser, AdminLoginLog, ADMIN_ROLES, Category, Product, User
...
def products(admin):
    ...
    return render_template('admin/products.html', admin=admin, products=products,
...
def add_product(admin):
    ...
    p = Product(name=name, price=price, image=image,
